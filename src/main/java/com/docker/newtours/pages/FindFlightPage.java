...
public class FindFlightPage {
	...
	private WebElement firstSubmitButtton;
	...
	public void submitFindFlightPage() {
		this.wait.until(ExpectedConditions.elementToBeClickable(this.firstSubmitButtton));
		this.firstSubmitButtton.click();
	}

	public void submitFlightConfirmationPage() {
